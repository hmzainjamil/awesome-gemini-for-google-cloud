...
| # | Path | Purpose |
|---|---|---|
| 1 | [`README.md`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md) | Task-shaped index of Gemini-on-GCP patterns |
| 2 | [`LICENSE`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/LICENSE) | MIT — fork, edit, PR |
| 3 | [`README.md#long-context`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#long-context) | 1M+ token document QA recipes |
| 4 | [`README.md#function-calling`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#function-calling) | Structured tool use with Gemini |
| 5 | [`README.md#grounded`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#grounded) | Google Search grounding for citations |
| 6 | [`README.md#cost`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#cost) | Batch API, caching, model routing |
| 7 | [`README.md#workspace`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#workspace) | Docs/Sheets/Gmail Gemini extensions |
| 8 | [`README.md#vertex-search`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#vertex-search) | RAG with Vertex Search |
| 9 | [`README.md#imagen`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#imagen) | Image generation pipelines |
| 10 | [`README.md#archive`](https://github.com/hmzainjamil/awesome-gemini-for-google-cloud/blob/main/README.md#archive) | Deprecated APIs with migration paths |
...
Manifests are auditable, diffable, and language-agnostic. The moment behavior lives in code, you've coupled the contract to a runtime. `awesome-gemini-for-google-cloud` keeps behavior declared in a single source of truth so a non-author can audit it without grokking the runtime.

### Why no telemetry?

Trust is one-way: once you ship a phone-home, you can never unship it. `awesome-gemini-for-google-cloud` ships with `TELEMETRY=off` and no fallback. If you want metrics, instrument your own deployment.
...
Daemons are state that outlives the user's mental model. `awesome-gemini-for-google-cloud` is invoked, runs, exits. The only persisted state is the explicit ledger / log file you can `cat`.
...
**Q: Will `awesome-gemini-for-google-cloud` work without Claude Code?**  
...
`awesome-gemini-for-google-cloud` is small enough to read end-to-end in an evening and opinionated enough to teach you something on every pass. Fork it, ship something with it, then file an issue with what you learned. That's how the next version gets built.
...
This repo is mirrored to no third party. The canonical URL is `https://github.com/hmzainjamil/awesome-gemini-for-google-cloud`. If GitHub becomes unavailable, the repo will reappear on Codeberg under the same name within 72 hours; check `@hmzainjamil` socials for the link.
...
Treat `awesome-gemini-for-google-cloud` as a pipeline: input enters, runs through declared stages, emits an output. No surprise side-channels. If you can't draw it on a napkin, the design is wrong.
...
You've read this far. Either you're evaluating `awesome-gemini-for-google-cloud` seriously, or you're studying it. Both are good outcomes. Open an issue with whatever felt missing — that's how this README earns its next thousand stars.
